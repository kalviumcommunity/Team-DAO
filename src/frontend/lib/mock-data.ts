...
export const ELECTRONICS_PRODUCTS: Product[] = [
  {
    ...
    description: "Ultra-thin Midnight Blue M2 MacBook Air with Retina display. Battery health 98%, includes MagSafe charger and original box.",
  ...
  },
  {
    ...
    condition: "Good",
    category: "Electronics",
    description: "Rechargeable color graphing calculator required for STEM courses. Loaded with exam apps and mini-USB charging cable.",
    durationUsed: "1 year",
    trending: true,
    image:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuC37qcJNpUdr-R5YxWgO3inqO6KGtd2yuy4AjbOPccE9SJzK2r5piGXMT6JzOj8njpt_h_wKY-cxAHqlGfyHddoe1EEK3cHypzDlvNuqDGKBjOuzfBOpiseNnav4oFMO43QRgDWF59AsMQdCXfjJo0SL_1RKJLBjeOyaNctVjrU5maJcyyZNlsIwYbhbwLcsxYdkwFazbqLZ0A10logEVhp3H1rTX8KKrs-Zc6b2GBkG0mmybHuIttIutdLyqm1q1n9lTbQALqlbZGp",
  ...
  {
    id: "led-desk-lamp",
    name: "Modern Touch LED Desk Lamp",
    price: "$22.00",
    originalPrice: "$38.00",
    condition: "Used",
    category: "Electronics",
    description: "Adjustable color temperature (3000K-6000K) LED desk light with integrated 5V USB phone charging port.",
    durationUsed: "5 months",
    image:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuCJ9bJ3tIWbjdRTpUB7PEy9jMa13H9aWxNdJZwogGB2aDUuddJ_FbBPn8miRA8ihdHJ0CyN1p8OEz3MdLxWqs5ETFT2P85YkQGcU9mNH30paOeNXay6KtFXi9GBI4dqguQn6wOjdC4mu4wkeA3kuMQ9F0T4u5iUNNJxpYK8OqlIcnRdtliRjDMJByU2KeavUnJKuRN-N2RMjvtgg7yAlKRZQEonIwqmnqjCeef8yxBfprYzj2xox5Up7MTFczgAK4z-LnH9wMsfDZ6W",
    imageAlt: "Brushed silver modern LED desk lamp on a white background",
  },
...
export const BOOK_PRODUCTS: Product[] = [
  {
    ...
    condition: "Used",
    category: "Books",
    description: "Comprehensive university calculus textbook focusing on differential forms, vector fields, and geometric insights. Minimal highlighting.",
  ...
  },
  {
    ...
    condition: "New",
    category: "Books",
    description: "Modern guide to UI/UX tokens, design component architecture, and natural visual harmony for digital interfaces.",
    durationUsed: "Brand New",
    trending: false,
    image:
  ...
  },
  {
    ...
    condition: "Used",
    category: "Books",
    description: "Step-by-step handbook covering orthographic projection, scale modeling, and hand drafting techniques.",
    durationUsed: "4 months",
    trending: true,
    image:
  ...
  },
  {
    ...
    condition: "Used",
    category: "Books",
    description: "Essential medical reference volume with clinical correlation boxes, surface anatomy diagrams, and online access code.",
    durationUsed: "1 year",
    trending: false,
    image:
  ...
  },
  {
    ...
    condition: "New",
    category: "Books",
    description: "Classic American poetry collection features Walt Whitman's complete original 1855 verse arrangement.",
    durationUsed: "Brand New",
    trending: false,
    image:
  ...
  },
  {
    ...
    condition: "Used",
    category: "Books",
    description: "Robert C. Martin's software engineering classic on code refactoring, meaningful naming, and unit testing practices.",
...
export const STATIONERY_PRODUCTS: Product[] = [
  {
    id: "minimalist-notebook-set",
    name: "Minimalist Notebook Set (3-Pack)",
    price: "$24.00",
    originalPrice: "$30.00",
    condition: "New",
    category: "Stationery",
    description: "Premium 100gsm dot-grid journals with durable hardcover binding, perfect for lecture notes and bullet journaling.",
    durationUsed: "Brand New",
    trending: true,
    ...
    imageAlt: "Minimalist Notebook Set 3-pack on white wooden desk",
  },
  {
    id: "pastel-highlighter-pack",
    name: "Pastel Highlighter Pack (6 Colors)",
    price: "$12.50",
    originalPrice: "$16.00",
    condition: "New",
    category: "Stationery",
    description: "Soft pastel aesthetic highlighters featuring quick-dry non-bleed water-based ink.",
    durationUsed: "Brand New",
    trending: true,
    ...
    imageAlt: "Pack of 6 pastel aesthetic highlighters",
  },
  {
    id: "pro-mechanical-pencil",
    name: "Pro 0.5mm Mechanical Pencil",
    price: "$18.00",
    originalPrice: "$22.00",
    condition: "Like New",
    category: "Stationery",
    description: "Heavy-duty knurled grip mechanical drafting pencil for precise sketching and technical diagramming.",
    ...
    imageAlt: "Metallic mechanical pencil on grid sketchbook",
  },
  {
    id: "desktop-stapler",
    name: "Compact Desktop Stapler",
    price: "$15.99",
    condition: "Good",
    category: "Stationery",
    description: "Sturdy steel mechanism capable of binding up to 30 sheets of paper at once. Includes 1000 staples.",
    ...
    imageAlt: "Compact matte black desktop stapler",
  },
  {
    id: "sticky-note-bundle",
    name: "Sticky Note Bundle (8 Pads)",
    price: "$8.00",
    condition: "New",
    category: "Stationery",
    description: "Self-adhesive removable notes in 8 soothing pastel hues for textbook flagging and revision wall prep.",
    durationUsed: "Brand New",
    ...
    imageAlt: "Stack of colorful pastel sticky note pads",
  },
  {
    id: "metal-geometry-box",
    name: "Metal Geometry & Compass Box",
    price: "$22.00",
    condition: "Like New",
    category: "Stationery",
    description: "Full mathematical drafting toolkit in protective metal tin. Includes precision compass, protractor, set squares.",
    durationUsed: "2 months",
    ...
    imageAlt: "Metal tin geometry kit with precision compass",
  },
];
